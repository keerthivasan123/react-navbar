    ...
    return (
      <Layout>
        <Sider trigger={null} className="sider" style={{ width: "30%" }}>
          ...
          <Avatar
            size={100}
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT4A9OCZw8_C5JE790_AZw0v12xZ_sIAtgGVYphJAm53qBZQDjX&usqp=CAU"
        ...
        <Layout className="site-layout pr-2" style={{ width: "70%" }}>
          ...
          >
            ...
            <div
              className="pt-0"
              style={{ width: "100%", height: 55, maxHeight: "500px" }}
            >
              <div className="float-left pr-5 mr-4">
                <StarFilled
                  style={{ fontSize: "35px", padding: 10, color: "pink" }}
                  className="float-left align-middle"
                />
                <h6 className="float-left align-middle pr-2 pt-3">
                  Aircraft Down
                </h6>
              ...
              <div className="float-left pr-5 mr-4 ">
                <StarFilled
                  style={{ fontSize: "35px", padding: 10, color: "yellow" }}
                  className="float-left align-middle"
                />
                <h6 className="float-left align-middle pr-2 pt-3">
                  Inseption Down
              ...
              <div className="float-left pr-5 mr-4 ">
                <StarFilled
                  style={{ fontSize: "35px", padding: 10, color: "green" }}
                  className="float-left align-middle"
                />
                <h6 className="float-left align-middle pr-2 pt-3">
                  Aircraft Up
          ...
          <div className="pt-1 ecosystem" style={{ width: "100%", height: 55 }}>
            <h3 className="float-left ecosystem pl-2 pt-1 align-middle">
              Ecosystem
            </h3>
            <div className="float-right pr-2 pt-1 align-middle">
              <Button
                size="large"
                className="findEcosystem"
                style={{ border: 0 }}
              >
                Find-Ecosystem
              </Button>
